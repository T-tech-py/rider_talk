...
class AppThemes {
  ...
  static final TextTheme _lightTextTheme =  TextTheme(
   ...
   // headline1: TextStyle(fontSize: 20.0, color: AppColors.cTextColor),
...
//text theme for dark theme
  ...
  static final ThemeData darkTheme = ThemeData(
    brightness: AppColors.cPrimaryBrightnessDark,
    //primarySwatch: AppColors.darkPrimaryColor, //cant be Color on MaterialColor so it can compute different shades.
    hintColor: AppColors.cAccentColor, //prefix icon color form input on focus
    ...
    appBarTheme: const AppBarTheme(
      ...
      iconTheme: IconThemeData(color: AppColors.cPrimaryColor),
